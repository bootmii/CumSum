...
public class EvenOddThing {
	...
	public static ArrayList<Integer> getNumsFromConsole() {
		...
		/*
		 * This do statement ensures the while comparison is at the end,
		 * when num has the chance to be the valued entered into stdin.
		 * It also ensures that the last value of the array becomes -1,
		 * which is why we remove it in the final line of the method.
		 */
		do {
